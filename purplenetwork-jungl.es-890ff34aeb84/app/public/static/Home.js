(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ...
  \************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../modules/store */ "./src/scripts/modules/store.js"
        );
  ...
  \******************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var hammerjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! hammerjs */ "./node_modules/hammerjs/hammer.js"
        );
        /* harmony import */ var hammerjs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
          hammerjs__WEBPACK_IMPORTED_MODULE_2__
        );
        /* harmony import */ var _modules_WheelManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../modules/WheelManager */ "./src/scripts/modules/WheelManager.js"
        );
        ...
        var Slider = function Slider(prop) {
          ...
          this.initEventListeners = function() {
            if (
              _modules_store__WEBPACK_IMPORTED_MODULE_1__["default"].hasTouch
            ) {
          ...
          this.__slideTo = function(e, forcedDirection) {
            var direction = forcedDirection
              ? forcedDirection
              : _this.__getDirection(e);
            var nextSection = null;

            if (direction == "down") {
              nextSection =
                _modules_store__WEBPACK_IMPORTED_MODULE_1__["default"]
          ...
          if (_modules_store__WEBPACK_IMPORTED_MODULE_1__["default"].hasTouch) {
            this.touchGesture = new hammerjs__WEBPACK_IMPORTED_MODULE_2___default.a.Manager(
              document.body
            );
            this.touchGesture.add(
              new hammerjs__WEBPACK_IMPORTED_MODULE_2___default.a.Swipe({
                direction:
                  hammerjs__WEBPACK_IMPORTED_MODULE_2___default.a
                    .DIRECTION_VERTICAL
              })
            );
          } else {
            this.wheelManager = new _modules_WheelManager__WEBPACK_IMPORTED_MODULE_3__[
              "default"
            ]({
  ...
  \*********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../modules/store */ "./src/scripts/modules/store.js"
        );
        ...
        var Blob = function Blob(_ref) {
          ...
          this.__prepareForShow = function() {
            ...
            _this.maskAnimation = gsap__WEBPACK_IMPORTED_MODULE_1__[
              "default"
            ].to(_this.domElement, {
              duration: 0.35,
              x: values.position.x,
            ...
            _this.imageAnimation = gsap__WEBPACK_IMPORTED_MODULE_1__[
              "default"
            ].to(_this.imgElement, {
              duration: 0.35,
              opacity: 1,
          ...
          this.__prepareValues = function(_ref2) {
            ...
            var deltaX = _modules_store__WEBPACK_IMPORTED_MODULE_3__["default"]
              .isMobileOrTabletPortrait
              ? DELTA_MOBILE_X
              : DELTA_X;
            var deltaY = _modules_store__WEBPACK_IMPORTED_MODULE_3__["default"]
              .isMobileOrTabletPortrait
              ? DELTA_MOBILE_Y
              : DELTA_Y; // if (this.isIOSChrome) {
            ...
            if (reset) {
              if (_this.isIOSChrome) {
                ...
                gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(
                  ...
                  {
                    transformOrigin: ""
                      .concat(newCenter.x, "px ")
                      .concat(newCenter.y, "px"),
                    x: 0,
                    y: 0,
                    scale: 0
                  }
                ...
                switch (
                  _modules_store__WEBPACK_IMPORTED_MODULE_3__["default"].browser
                    .getBrowserName()
                    .toLowerCase()
                ) {
                  case "firefox":
            ...
            if (
              _modules_store__WEBPACK_IMPORTED_MODULE_3__["default"].isMobile &&
          ...
          this.__getPosition = function() {
            return {
              x:
                (window.innerWidth -
                  _this.domElement.getAttribute("data-original-width")) /
                2,
              y:
                (window.innerHeight -
                  _this.domElement.getAttribute("data-original-height")) /
                2
            };
          };
          ...
          this.__getScale = function() {
            return Math.max(
              window.innerWidth / _this.domElement.getAttribute("data-scale-w"),
              window.innerHeight / _this.domElement.getAttribute("data-scale-h")
            );
          };
          ...
          if (
            _modules_store__WEBPACK_IMPORTED_MODULE_3__["default"].isMobile &&
            _modules_store__WEBPACK_IMPORTED_MODULE_3__[
              "default"
            ].browser.parsedResult.browser.name.toLowerCase() == "chrome"
          ) {
  ...
  \****************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./animations */ "./src/scripts/components/header/menu/animations.js"
        );
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../../modules/store */ "./src/scripts/modules/store.js"
        );
        /* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! gsap */ "./node_modules/gsap/index.js"
        );
        ...
        var Menu = function Menu(_ref) {
          ...
          this.initListeners = function() {
            ...
            if (
              !_modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
                .isMobileOrTablet
            ) {
              _this.hamburgerParentDomElement.addEventListener(
                "mouseenter",
                function() {
            ...
            Object.values(_this.footerNav.querySelectorAll("a")).map(function(
              item
            ) {
            ...
            document
              ...
              .addEventListener("click", _this.__onItemClick);
          };
          ...
          this.selectMenuItem = function() {
            ...
            var newItem = _this.nav.querySelector(
              "[data-id=".concat(
                _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
                  .selectedSection.id,
                "]"
          ...
          this.__foterItemClick = function(event) {
            ...
            if (document.body.classList.contains("has-menu"))
              _this.hamburgerParentDomElement.click();
            var section = _modules_store__WEBPACK_IMPORTED_MODULE_2__[
              "default"
            ].getSectionById(dom.getAttribute("data-id"));
          ...
          this.__onItemClick = function(event) {
            ...
            var previousIndex =
              _this.selectedItem !== null
                ? _this.__getItemIndex(_this.selectedItem)
                : -1;
            var direction = previousIndex > index ? "down" : "up";
            var section = _modules_store__WEBPACK_IMPORTED_MODULE_2__[
              "default"
            ].getSectionById(dom.getAttribute("data-id")); // close menu
          ...
          gsap__WEBPACK_IMPORTED_MODULE_3__["default"].set(
            this.backgroundDomElement,
            {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_3__["default"].set(
            this.backgroundHoverDomElement,
            {
              transformOrigin: "50% 50%",
              x: 130,
              y: -130,
          ...
          this.animationOver = _animations__WEBPACK_IMPORTED_MODULE_1__[
            "default"
          ].mouseOver({
          ...
          if (
            _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"].isMobile &&
            window.innerHeight <= 600
          ) {
  ...
  \**********************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! gsap */ "./node_modules/gsap/index.js"
        );
        /* harmony import */ var _modules_animationSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../../../modules/animationSettings */ "./src/scripts/modules/animationSettings.js"
        );
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../../modules/store */ "./src/scripts/modules/store.js"
        ...
        var animations = {
          show: function show(_ref) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to($dom, {
              duration:
                _modules_animationSettings__WEBPACK_IMPORTED_MODULE_1__[
                  "Duration"
                ].introDuration,
              x: -80,
              opacity: 1,
              ease:
                _modules_animationSettings__WEBPACK_IMPORTED_MODULE_1__["Ease"]
                  .power3InOut,
              onComplete: function onComplete() {
          ...
          close: function close(_ref7) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_0__["default"]
              .to([$dom, $footerDom], {
                duration: 0.25,
                stagger: -0.1,
                opacity: 0,
          ...
          open: function open(_ref8) {
            ...
            if (
              ...
              _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"].isTablet ||
              _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"].hasTouch
            ) {
              if (
                _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
                  .isPortrait
  ...
  \***********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_1__["default"].registerPlugin(
        ...
        var Intro = function Intro(_ref) {
          ...
          Promise.resolve([])
            .then(function() {
              // draw outline
              return gsap__WEBPACK_IMPORTED_MODULE_1__["default"].from(
                logo.children,
                {
                  duration:
                    _modules_animationSettings__WEBPACK_IMPORTED_MODULE_2__[
            ...
            .then(function() {
              ...
              return (
                gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to(
                  Object.values(logo.children).splice(1),
                  {
                    duration: 0.5,
                    fill: "#FFFFFF",
                    ease: "none"
            ...
            .then(function() {
              // hide logo
              return gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to(
                logo.parentNode,
                {
                  duration:
                    _modules_animationSettings__WEBPACK_IMPORTED_MODULE_2__[
  ...
  \*********************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./animations */ "./src/scripts/components/pagination/animations.js"
        );
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../modules/store */ "./src/scripts/modules/store.js"
        );
        ...
        var Pagination = function Pagination(_ref) {
          ...
          this.update = function() {
            if (
              _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
                .selectedSection.hasPagination
            ) {
              var singleVoiceDom = _this.numbersDomElement.querySelector(
                "[data-id=".concat(
                  _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
                    .selectedSection.id,
                  "]"
              ...
              var _barScale =
                (_this.__getItemIndex(_this.selectedItemDomElement) + 1) /
                _this.items.length;
          ...
          this.__onNumberClick = function(event) {
            ...
            var previousIndex =
              _this.selectedItemDomElement !== null
                ? _this.__getItemIndex(_this.selectedItemDomElement)
                : -1;
            var direction = previousIndex > index ? "down" : "up";
            var section = _modules_store__WEBPACK_IMPORTED_MODULE_2__[
              "default"
  ...
  \**********************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./animations */ "./src/scripts/components/scroll-suggestion/animations.js"
        );
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../modules/store */ "./src/scripts/modules/store.js"
        );
        ...
        var ScrollSuggestion = function ScrollSuggestion(_ref) {
          ...
          this.show = function() {
            _animations__WEBPACK_IMPORTED_MODULE_1__["default"]
              .show({
            ...
            switch (
              ...
              case "connect":
                if (
                  ...
                  _animations__WEBPACK_IMPORTED_MODULE_1__[
                    "default"
                  ].connectVersion({
                    $dom: _this.domElement,
  ...
  \****************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./animations */ "./src/scripts/components/sections/animations.js"
        );
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../modules/store */ "./src/scripts/modules/store.js"
        );
        /* harmony import */ var _blob_Blob__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../blob/Blob */ "./src/scripts/components/blob/Blob.js"
        );
        ...
        var Section = /*#__PURE__*/ (function() {
          function Section(data) {
            ...
            this.activate = function() {
              if (
                ...
                switch (
                  _modules_store__WEBPACK_IMPORTED_MODULE_3__[
                    "default"
                  ].browser.parsedResult.browser.name.toLowerCase()
                ) {
                  case "firefox":
                  case "safari":
                    setTimeout(function() {
            ...
            this.hideIconsAnimation = _animations__WEBPACK_IMPORTED_MODULE_2__[
              "default"
            ].hideIcons({
            ...
            if (this.id !== "play") {
              ...
              this.blob = new _blob_Blob__WEBPACK_IMPORTED_MODULE_4__[
                "default"
              ]({
            ...
            [
              {
                ...
                value: function enter(callback) {
                  ...
                  if (
                    !_modules_store__WEBPACK_IMPORTED_MODULE_3__["default"]
                      .isMobile &&
                    this.descriptionDomElement !== null
                  ) {
                    _animations__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].showDescription(this.descriptionDomElement);
                  }
                  ...
                  if (this.id !== "play" && this.id !== "contact") {
                    ...
                    if (typeof this.anim1 == "undefined") {
                      this.anim1 = _animations__WEBPACK_IMPORTED_MODULE_2__[
                        "default"
                      ].enter({
                        $dom: this.ico1DomElement,
                        settings: _modules_store__WEBPACK_IMPORTED_MODULE_3__[
                          "default"
                        ].isMobile
                          ? this.data.background1Animation.mobile
                          : this.data.background1Animation.desktop
                      });
                      this.anim2 = _animations__WEBPACK_IMPORTED_MODULE_2__[
                        "default"
                      ].enter({
                ...
                value: function exit(callback) {
                  ...
                  if (this.id !== "play" && this.id !== "contact") {
                    if (this.data.animReversable) {
                      ...
                      _animations__WEBPACK_IMPORTED_MODULE_2__["default"]
                        .exit({
                          $dom: this.ico1DomElement,
                          settings: _modules_store__WEBPACK_IMPORTED_MODULE_3__[
                            "default"
  ...
  \*******************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
        ...
        /* harmony import */ var _Section__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../Section */ "./src/scripts/components/sections/Section.js"
        );
        /* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ./animations */ "./src/scripts/components/sections/contact/animations.js"
        );
        ...
        var ContactSection = /*#__PURE__*/ (function(_Section) {
          ...
          function ContactSection(_ref) {
            ...
            _this.enterAnimation = _animations__WEBPACK_IMPORTED_MODULE_7__[
              "default"
            ].enter({
              $dom: _this.domElement
            });
  ...
  \*************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ./animations */ "./src/scripts/components/sections/play/animations.js"
        );
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ../../../modules/store */ "./src/scripts/modules/store.js"
        );
          ...
          function PlaySection(data) {
            ...
            _this.enter = function(callback) {
              ...
              _this.enterAnimation.play().then(function() {
                _this.activeDomElement.addEventListener(
                  "mouseover",
                  _this.__onMouseOver
                );
              ...
              if (
                _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].hasTouch
              ) {
            ...
            _this.exit = function(callback) {
              _this.activeDomElement.removeEventListener(
                "mouseover",
                _this.__onMouseOver
              );
              ...
              _this.enterAnimation.reverse().then(function() {
                ...
                if (
                  !_modules_store__WEBPACK_IMPORTED_MODULE_8__["default"]
                    .isMobile
                ) {
            ...
            _this.resize = function() {
              ...
              if (_this.isLeafOpened) {
                _animations__WEBPACK_IMPORTED_MODULE_7__[
                  "default"
                ].resizeOpenLeaf({
                  $dom: _this.leaf
                });
            ...
            _this.__repositionFakeTitle = function() {
              ...
              var pos =
                scrollBounding.y -
                originalActiveBoundingClient.y +
                scrollBounding.height;
              var diff = pos - 400;
              diff = 70 + diff / 2;
              _this.activeDomElement.style.height = "".concat(pos, "px");
              _this.activeDomElement.style.top = "calc(50% + ".concat(
                diff,
                "px)"
              );
            };
            ...
            _this.openLeafAnimation = _animations__WEBPACK_IMPORTED_MODULE_7__[
              "default"
            ].openLeaf({
              $dom: _this.leaf
            });
  ...
  \************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        function getEnterValues() {
          var y = _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
            .isMobileOrTabletPortrait
            ? -450
            : -806;
          var scale = 1;
          ...
          if (
            _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"].isTablet &&
            _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"].isPortrait
          ) {
            scale = window.innerHeight / 700;
        ...
        function getLeafValues() {
          ...
          var leaf3 = {
            rotate: _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
              .isMobileOrTabletPortrait
              ? 10
              : 20,
            x: _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
              .isMobileOrTabletPortrait
              ? 50
              : 76,
            y: _modules_store__WEBPACK_IMPORTED_MODULE_2__["default"]
              .isMobileOrTabletPortrait
              ? 60
              : 72,
            scale: 0.9
  ...
  \***********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./animations */ "./src/scripts/components/title/animations.js"
        );
        /* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! gsap */ "./node_modules/gsap/index.js"
        );
        ...
        var Title = function Title(_ref) {
          ...
          this.show = function() {
            _animations__WEBPACK_IMPORTED_MODULE_2__["default"].show(
              _this.domElement
            );
          };
          ...
          this.fadeIn = function() {
            ...
            _this.style =
              _modules_store__WEBPACK_IMPORTED_MODULE_1__[
                "default"
              ].selectedSection.titleStyle;
          };
          ...
          this.animate = function(direction) {
            ...
            if (
              _modules_store__WEBPACK_IMPORTED_MODULE_1__["default"]
                .selectedSection.titleStyle != _this.style
            ) {
              switch (
                _modules_store__WEBPACK_IMPORTED_MODULE_1__["default"]
                  .selectedSection.titleStyle
          ...
          this.convertToStandardTitle = function() {
            ...
            _animations__WEBPACK_IMPORTED_MODULE_2__["default"].updateSubLine({
              ...
              isMobile:
                _modules_store__WEBPACK_IMPORTED_MODULE_1__["default"].isMobile
            });
          };
          ...
          this.__horizontalize = function() {
            if (
              ...
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].mobileWordsAnimations.letMovement.play();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].mobileWordsAnimations.dynMovement.play();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].mobileWordsAnimations.outMovement.play();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].mobileWordsAnimations.thereMovement.play();
            } else {
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].desktopWordsAnimations.letMovement.play();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].desktopWordsAnimations.dynMovement.play();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].desktopWordsAnimations.outMovement.play();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].desktopWordsAnimations.thereMovement
                .play()
                .then(function() {
          ...
          this.__verticalize = function() {
            if (
              ...
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].mobileWordsAnimations.letMovement.reverse();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].mobileWordsAnimations.dynMovement.reverse();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].mobileWordsAnimations.outMovement.reverse();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].mobileWordsAnimations.thereMovement.reverse();
            } else {
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].desktopWordsAnimations.letMovement.reverse();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].desktopWordsAnimations.dynMovement.reverse();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].desktopWordsAnimations.outMovement.reverse();
              _animations__WEBPACK_IMPORTED_MODULE_2__[
                "default"
              ].desktopWordsAnimations.thereMovement.reverse();
            }
          ...
          this.__changeWordBySlide = function(direction) {
            var nextWordDomElement = document.querySelector(
              ".js-title-vertical-item[data-id=".concat(
                _modules_store__WEBPACK_IMPORTED_MODULE_1__["default"]
                  .selectedSection.id,
                "]"
          ...
          if (
            ...
            this.domElement
              ...
              .addEventListener("mouseout", function(e) {
                var fakeTitle = document.querySelector(
        ...
        var animations = {
          ...
          show: function show($domElement) {
            ...
            switch (
              ...
              case true:
                y =
                  -(window.innerHeight / 2 + $domElement.clientHeight * 0.5) -
                  66;
          ...
          desktopWordsAnimations: {
            letMovement: gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(
              document.querySelector(".js-title-let"),
              {
                duration: 0.4,
                x: -202,
                y: 70,
            ...
            dynMovement: gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(
              document.querySelector(".js-title-dynamic"),
              {
                duration: 0.4,
                x: -58,
                y: 4,
            ...
            outMovement: gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(
              document.querySelector(".js-title-out"),
              {
                duration: 0.4,
                x: 68,
                y: -66,
            ...
            thereMovement: gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(
              document.querySelector(".js-title-there"),
              {
                duration: 0.4,
                x: 192,
                y: -134,
          ...
          colorizeDynamicWord: function colorizeDynamicWord(_ref6) {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(
              document.querySelectorAll(".js-title-dynamic span"),
              {
                duration: 0.4,
                color: color,
                ease:
  ...
  \***********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../Page */ "./src/scripts/controllers/Page.js"
        );
        /* harmony import */ var _config_SectionSettings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ../../../config/SectionSettings */ "./src/config/SectionSettings.js"
        );
        /* harmony import */ var _modules_store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ../../modules/store */ "./src/scripts/modules/store.js"
        );
        /* harmony import */ var _components_intro_Intro__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ../../components/intro/Intro */ "./src/scripts/components/intro/Intro.js"
        );
        /* harmony import */ var _components_header_menu_Menu__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ../../components/header/menu/Menu */ "./src/scripts/components/header/menu/Menu.js"
        );
        /* harmony import */ var _components_Slider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ../../components/Slider */ "./src/scripts/components/Slider.js"
        );
        /* harmony import */ var _components_title_Title__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ../../components/title/Title */ "./src/scripts/components/title/Title.js"
        );
        /* harmony import */ var _components_sections_play_PlaySection__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ../../components/sections/play/PlaySection */ "./src/scripts/components/sections/play/PlaySection.js"
        );
        /* harmony import */ var _components_Background__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ../../components/Background */ "./src/scripts/components/Background.js"
        );
        /* harmony import */ var _components_sections_Section__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ../../components/sections/Section */ "./src/scripts/components/sections/Section.js"
        );
        /* harmony import */ var _components_header_Logo_Logo__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ../../components/header/Logo/Logo */ "./src/scripts/components/header/Logo/Logo.js"
        );
        /* harmony import */ var _components_pagination_Pagination__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ../../components/pagination/Pagination */ "./src/scripts/components/pagination/Pagination.js"
        );
        /* harmony import */ var _components_scroll_suggestion_ScrollSuggestion__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ../../components/scroll-suggestion/ScrollSuggestion */ "./src/scripts/components/scroll-suggestion/ScrollSuggestion.js"
        );
        /* harmony import */ var _components_sections_contact_ContactSection__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
          /*! ../../components/sections/contact/ContactSection */ "./src/scripts/components/sections/contact/ContactSection.js"
        );
        /* harmony import */ var _components_Form__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
          /*! ../../components/Form */ "./src/scripts/components/Form/index.js"
        );
        /* harmony import */ var _components_RotateDevice__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
          /*! ../../components/RotateDevice */ "./src/scripts/components/RotateDevice.js"
        );
            ...
            [
              {
                ...
                value: function init() {
                  ...
                  this.prevSection = null;
                  this.title = new _components_title_Title__WEBPACK_IMPORTED_MODULE_12__[
                    "default"
                  ]({
                  ...
                  this.background = new _components_Background__WEBPACK_IMPORTED_MODULE_14__[
                    "default"
                  ]();
                  this.slider = new _components_Slider__WEBPACK_IMPORTED_MODULE_11__[
                    "default"
                  ]({
                    onChange: this.goTo
                  });
                  this.menu = new _components_header_menu_Menu__WEBPACK_IMPORTED_MODULE_10__[
                    "default"
                  ]({
                    onClick: this.goTo,
                  ...
                  this.headerLogo = new _components_header_Logo_Logo__WEBPACK_IMPORTED_MODULE_16__[
                    "default"
                  ]({
                  ...
                  this.pagination = new _components_pagination_Pagination__WEBPACK_IMPORTED_MODULE_17__[
                    "default"
                  ]({
                    onClick: this.goTo
                  });
                  this.scrollSuggestion = new _components_scroll_suggestion_ScrollSuggestion__WEBPACK_IMPORTED_MODULE_18__[
                    "default"
                  ]({
                    onClick: this.goTo
                  });
                  this.form = new _components_Form__WEBPACK_IMPORTED_MODULE_20__[
                    "default"
                  ]({
                    onResultCallback: this.slider.initEventListeners
                  });
                  new _components_RotateDevice__WEBPACK_IMPORTED_MODULE_21__[
                    "default"
                  ](); // init intro animation

                  this.intro = new _components_intro_Intro__WEBPACK_IMPORTED_MODULE_9__[
                    "default"
                  ]({
        ...
        Home.showFirstSection = function() {
          ...
          _modules_store__WEBPACK_IMPORTED_MODULE_8__[
            "default"
          ].sections[0].activate();
          _modules_store__WEBPACK_IMPORTED_MODULE_8__[
            "default"
        ...
        Home.goTo = function(section, direction) {
          ...
          _modules_store__WEBPACK_IMPORTED_MODULE_8__[
            "default"
          ].selectedSection = section; // 3- update menu
        ...
        Home.goToPlay = function(direction) {
          ...
          _modules_store__WEBPACK_IMPORTED_MODULE_8__[
            "default"
          ].selectedSection.enter(function() {
            Home.slider.initEventListeners();
            _modules_store__WEBPACK_IMPORTED_MODULE_8__[
              "default"
        ...
        Home.goToContact = function() {
          _modules_store__WEBPACK_IMPORTED_MODULE_8__[
            "default"
          ].selectedSection.prevSection = Home.prevSection;
          ...
          if (
            _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].isMobile ||
            _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].isTablet ||
            _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].hasTouch
          ) {
            Home.menu.hide();
          ...
          _modules_store__WEBPACK_IMPORTED_MODULE_8__[
            ...
            _modules_store__WEBPACK_IMPORTED_MODULE_8__[
              "default"
            ].selectedSection.activate(); // test maz
        ...
        Home.updateBlobStatus = function() {
          if (
            _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].isBlobVisible
          ) {
            switch (
              _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].isMobile
            ) {
        ...
        Home.toggleBlobForMobile = function() {
          ...
          _modules_store__WEBPACK_IMPORTED_MODULE_8__[
            "default"
          ].isBlobVisible = !_modules_store__WEBPACK_IMPORTED_MODULE_8__[
            "default"
          ].isBlobVisible;
        };
        ...
        Home.resize = function() {
          ...
          if (
            ...
            switch (
              _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].isPortrait
            ) {
              case true:
                Home.menu.fadeIn();
                break;
        ...
        Home.__createSections = function() {
          ...
          try {
            var _loop = function _loop() {
              ...
              switch (sectionObj.id) {
                case "play":
                  newSection = new _components_sections_play_PlaySection__WEBPACK_IMPORTED_MODULE_13__[
                    "default"
                  ](sectionObj);
                ...
                case "contact":
                  newSection = new _components_sections_contact_ContactSection__WEBPACK_IMPORTED_MODULE_19__[
                    "default"
                  ]({
                    data: sectionObj,
                ...
                default:
                  newSection = new _components_sections_Section__WEBPACK_IMPORTED_MODULE_15__[
                    "default"
                  ](sectionObj);
                  break;
              }
            ...
            for (
              var _iterator = _config_SectionSettings__WEBPACK_IMPORTED_MODULE_7__[
                  "default"
                ].sections[Symbol.iterator](),
                _step;
          ...
          try {
            for (
              var _iterator2 = _modules_store__WEBPACK_IMPORTED_MODULE_8__[
                  "default"
                ].sections
                  .entries()
                  [Symbol.iterator](),
              ...
              var _step2$value = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(
                  _step2.value,
                  2
                ),
              ...
              if (
                index <
                _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].sections
                  .length -
                  1
              ) {
                section.nextSection =
          ...
          _modules_store__WEBPACK_IMPORTED_MODULE_8__[
            ...
            _modules_store__WEBPACK_IMPORTED_MODULE_8__["default"].sections[0];
        };
  ...
  \*********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./store */ "./src/scripts/modules/store.js"
        );
        ...
        var WheelManager = function WheelManager(_ref) {
          ...
          this.initEventListener = function() {
            var $dom = document.querySelector(
              ".js-section[data-id=".concat(
                _store__WEBPACK_IMPORTED_MODULE_1__["default"].selectedSection
                  .id,
                "]"
              )
            );
